...
import classes from './PagBack.module.css';
...
const PagBack = (props) => {
    ...
    return (
        <div style={props.styleProp} className={classes.PagBack__Container}>
            <span onClick={props.clickMethod} className={classes.PagBack}>
                {backIcon}
            </span>
        </div>
    );
